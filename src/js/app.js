...
function render(variables = {}) {
  ...
  const role = variables.role != null ? variables.role : "Which is your Role?";
...
window.onload = function() {
  window.variables = {
    ...
    avatarURL:
      "https://c8.alamy.com/comp/2DA078H/blockchain-icon-vector-for-bitcoin-cryptocurrency-with-male-person-profile-avatar-for-digital-wallet-in-a-glyph-pictogram-illustration-2DA078H.jpg",
